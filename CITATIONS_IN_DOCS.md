...
Inline citations use `ADDIN ZOTERO_ITEM CSL_CITATION` followed by a CSL-JSON object:
...
<w:r>
  ...
  "citationID": "AQwSemPs",
  "properties": {"formattedCitation": "(Hawking, 2010)", "plainCitation": "(Hawking, 2010)", "noteIndex": 0},
  "citationItems": [{
    "id": 46,
    "uris": ["http://zotero.org/users/40613/items/EAG35HWU"],
    "itemData": {
      "id": 46,
...
<w:r><w:t>(Hawking, 2010)</w:t></w:r>
<w:r><w:fldChar w:fldCharType="end"/></w:r>
```

The bibliography field instruction begins with `ADDIN ZOTERO_BIBL` and ends with `CSL_BIBLIOGRAPHY`:

```xml
<w:instrText xml:space="preserve"> ADDIN ZOTERO_BIBL {"uncited": [], "custom": []} CSL_BIBLIOGRAPHY </w:instrText>
```
...
|---------|-------------|-------------------|------------|-----------------|
| Zotero | `ADDIN ZOTERO_ITEM CSL_CITATION {json}` | `ADDIN ZOTERO_BIBL {json} CSL_BIBLIOGRAPHY` | reference mark: `ZOTERO_ITEM CSL_CITATION {json}` | reference mark: `ZOTERO_BIBL ... CSL_BIBLIOGRAPHY` |
