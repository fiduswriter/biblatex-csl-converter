...
While writing this library, we have had a lot of experience with converting between CSL and BibLaTeX and also worked with the exports an imports generated by Zotero. These are open soruce/free software and it is therefore easy to check whether the conversions are correct. Conversions involving these formats are therefore generally better.

Other software, such as Endnote, Citavi, and Mendeley, are proprietary and closed source, making it more difficult, especially without a license of these products. We rely on publicly available documentation and ODT/DOCX test files produced by others to understand how these formats work and to test our conversions. If something is not converted correctly, please report it so we can improve the library - example files are welcome.
