...
},{"./bitmask":2,"./util":5}],4:[function(require,module,exports){
'use strict'
...
},{"./grammar":3,"nearley":6}],5:[function(require,module,exports){
'use strict'
...
},{"./bitmask":2}],6:[function(require,module,exports){
(function () {
...
},{"../const":7,"./const":9}],9:[function(require,module,exports){
'use strict';
...
var CSLExporter = exports.CSLExporter = function () {
    ...
    _createClass(CSLExporter, [{
        ...
        value: function _reformDate(dateStr) {
            var dateObj = (0, _parser.parse)(dateStr.replace(/^y/, 'Y') // Convert to edtf draft spec format supported by edtf.js
...
},{"../const":7,"edtf/src/parser":4}],11:[function(require,module,exports){
"use strict";
...
var BibLatexParser = exports.BibLatexParser = function () {
    ...
    _createClass(BibLatexParser, [{
        ...
        value: function _reformDate(dateStr) {
            ...
            try {
                var dateObj = (0, _parser.parse)(cleanDate.replace(/^y/, 'Y') // Convert to edtf draft spec format supported by edtf.js
                .replace(/unknown/g, '*').replace(/open/g, '').replace(/u/g, 'X').replace(/\?~/g, '%'));
...
},{"../const":7,"./const":12,"./literal-parser":13,"./name-parser":14,"./tools":15,"edtf/src/parser":4}],12:[function(require,module,exports){
...
},{"./literal-parser":13}],15:[function(require,module,exports){
'use strict';
...
},{"./const":7,"./export/biblatex":8,"./export/csl":10,"./import/biblatex":11}]},{},[1]);
